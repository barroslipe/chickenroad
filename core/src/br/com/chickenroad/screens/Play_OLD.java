 ...
 *
 */
public class Play_OLD extends ScreenBase {
	...
	public Play_OLD(String urlMap, ChickenRoadGame aChickenRoadGame) {
		...
		this.player = new Player(myMap.getWidthTiledMap(), myMap.getHeightTiledMap(), getAssetManager());
	...
	private void draw(float delta) {
		...
		playCamera.setPosition(player.getPlayerAnimation().getX(), player.getPlayerAnimation().getY(), myMap.getWidthTiledMap(), myMap.getHeightTiledMap());
