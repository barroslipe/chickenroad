...
public class PopupGameOver {
	...
	public void draw(SpriteBatch spriteBatch){
		...
		spriteRestart.setPosition(Constantes.WORLD_WIDTH/2 - 3*spriteRestart.getWidth()/2 +PlayScreen.deltaXPositionButtons,  30+PlayScreen.deltaYPositionButtons);
		spriteFaseList.setPosition(Constantes.WORLD_WIDTH/2 + spriteFaseList.getWidth()/2+PlayScreen.deltaXPositionButtons,  30+PlayScreen.deltaYPositionButtons);
